...
%这是一个表格，请在相应位置输入相关信息 
       \begin{tabular}{p{2.5cm}p{9.4cm}}		
		...
		\cline{2-2} 
		\makecell[c]{\songti\bfseries\sanhaod 指导教师} 	& \makecell[c]{\songti\bfseries\sanhaod 李四} \\
		\cline{2-2} 
		\makecell[c]{\songti\bfseries\sanhaod 学\qquad 院} 	&  \makecell[c]{\songti\bfseries\sanhaod 光电工程学院/国际半导体学院} \\
		\cline{2-2}
...
\dlmu[14cm]{\songti\bfseries\xiaoerd 重庆邮电大学学位论文格式模板}\\
\vspace{5mm}
%请在此输入作者姓名
