...
%请在相关位置输入指导教师姓名，如果有第二导师请在第二行输入，如果没有，可以自行删去第二行
		...
		{\songti\bfseries\sanhaod  } \\
		\cline{2-2}
		&  \makecell[c]{\songti\bfseries\sanhaod \quad \,  \quad \, \qquad }\\ 
		\cline{2-2}
...
%请在相关位置输入相关信息，工程硕士、学硕及博士的部分类容有不同，请自行修改	
	...
	% \makecell[l]{\songti\xiaosid 专业学位领域} 	& \multicolumn{5}{c}{\songti\bfseries\sihaod 计算机科学与技术} \\
	%  \cline{2-6}
