...
%请在相关位置输入相关信息，工程硕士、学硕及博士的部分类容有不同，请自行修改	
	...
	\multicolumn{2}{l}{\songti\xiaosid 答辩委员会主席} 	&	\multicolumn{2}{c}{\songti\bfseries\sihaod 某某某 \quad 教授} &	\makecell[c]{\songti\xiaosid 论文答辩日期} & \makecell[c]{\songti\bfseries\sihaod 2025年5月17日}\\
	 \cline{3-4} \cline{6-6}
